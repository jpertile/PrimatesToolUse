...
tool_use_expanded <- read_xlsx(
  "PrimateToolUseDataset.xlsx", sheet = "Dataset")
...
ggplot(tool_use_expanded, aes(x = Omnivore, y = Tool_Use)) +
  geom_jitter(width = 0.2, height = 0.2, aes(color = Taxon), size = 3, alpha = 0.5) + 
...
ggplot(tool_use_expanded, aes(x = Frugivore, y = Tool_Use)) +
  geom_jitter(width = 0.2, height = 0.2, aes(color = Taxon), size = 3, alpha = 0.5) + 
  geom_smooth(method = glm, se = F, method.args= list(family="binomial")) +
  labs(title = "Frugivory vs. Tool Use") + 
  theme_minimal()

ggplot(tool_use_expanded, aes(x = Folivore, y = Tool_Use)) +
  geom_jitter(width = 0.2, height = 0.2, aes(color = Taxon), size = 3, alpha = 0.5) + 
  geom_smooth(method = glm, se = F, method.args= list(family="binomial")) +
  labs(title = "Folivory vs. Tool Use") + 
  theme_minimal()
